...
`v0.3.4` is type-checked, tested, built, and package-validated against DeepSeek Harness `0.1.2-rc.1` while retaining compatibility with `0.1.0-rc.5` through `rc.8` and `0.1.1-rc.1` through `rc.2`.
...
```sh
dsh plugin --profile web add https://github.com/Wanbinyu/dsh-plugin-git-inspect/releases/download/v0.3.4/dsh-plugin-git-inspect-0.3.4.tgz
```
